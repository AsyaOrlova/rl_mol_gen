...
import tf_slim
from tf_slim.layers import layers as contrib_layers
from tf_slim.training import training as contrib_training
...
class DeepQNetwork(object):
  ...
  def _build_training_ops(self):
    ...
    with tf.variable_scope(self.scope, reuse=self.reuse):
      ...
      self.optimization_op = tf_slim.optimize_loss(
